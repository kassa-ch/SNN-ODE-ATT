"""
trace_distance score module.

Drop-in demo1 usage:
    from Distance.trace_distance.score import DistanceCalculator
...
try:
    from Distance.common import TraceDistanceCalculator
except Exception:
    from ..common import TraceDistanceCalculator


DistanceCalculator = TraceDistanceCalculator
