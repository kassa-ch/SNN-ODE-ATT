"""
hamiltonian_energy score module.

Drop-in demo1 usage:
    from Distance.hamiltonian_energy.score import DistanceCalculator
...
try:
    from Distance.common import HamiltonianEnergyCalculator
except Exception:
    from ..common import HamiltonianEnergyCalculator


DistanceCalculator = HamiltonianEnergyCalculator
