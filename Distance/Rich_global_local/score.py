"""
Rich_global_local score module.

Drop-in demo1 usage:
    from Distance.Rich_global_local.score import DistanceCalculator
...
try:
    from Distance.common import RichGlobalLocalDistanceCalculator
except Exception:
    from ..common import RichGlobalLocalDistanceCalculator


DistanceCalculator = RichGlobalLocalDistanceCalculator
