"""
Sliced_Wasserstein score module.

Drop-in demo1 usage:
    from Distance.Sliced_Wasserstein.score import DistanceCalculator
...
try:
    from Distance.common import SlicedWassersteinDistanceCalculator
except Exception:
    from ..common import SlicedWassersteinDistanceCalculator


DistanceCalculator = SlicedWassersteinDistanceCalculator
