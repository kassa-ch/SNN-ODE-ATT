"""
sobolev_h1 score module.

Drop-in demo1 usage:
    from Distance.sobolev_h1.score import DistanceCalculator
...
try:
    from Distance.common import SobolevH1DistanceCalculator
except Exception:
    from ..common import SobolevH1DistanceCalculator


DistanceCalculator = SobolevH1DistanceCalculator
