...
Drop-in demo1 usage:
    from Distance.qre.score import DistanceCalculator
...
try:
    from Distance.common import QRECalculator
except Exception:
    from ..common import QRECalculator


DistanceCalculator = QRECalculator
