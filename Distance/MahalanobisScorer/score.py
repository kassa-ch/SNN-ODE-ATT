"""
MahalanobisScorer score module.

Drop-in demo1 usage:
    from Distance.MahalanobisScorer.score import DistanceCalculator
...
try:
    from Distance.common import MahalanobisDistanceCalculator
except Exception:
    from ..common import MahalanobisDistanceCalculator


DistanceCalculator = MahalanobisDistanceCalculator
